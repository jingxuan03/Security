...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Task updated successfully!'); window.location.href = 'admin.php';</script>";
    } else {
...
<body>
    <div class="edit-form">
        <button type="button" class="edit-back-button" onclick="window.location.href='admin.php'">Back</button>
        <h2>Edit Task</h2>
        
        <form action="aedit_task.php?id=<?php echo $taskId; ?>" method="POST" class="edit-task-form">
            <input 
                type="text" 
                name="taskName" 
